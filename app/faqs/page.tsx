                ...
                <div className="   font-bold ">
                    ...
                    <Accordion className="mt-4" type="single" collapsible>
                        <AccordionItem value="item-1" >
                            <AccordionTrigger className="px-2 text-xl text-start sm:text-4xl">Where is Core-Fit Gym?</AccordionTrigger>
                        ...
                        <AccordionItem className="mt-4" value="item-2" >
                            <AccordionTrigger className="px-2 text-xl text-start sm:text-4xl">How do I provide feedback about my membership experience?</AccordionTrigger>
                            <AccordionContent className="px-2">
                        ...
                        <AccordionItem className="mt-4" value="item-3" >
                            <AccordionTrigger className="px-2 text-xl text-start sm:text-4xl">How much does it cost for a membership?</AccordionTrigger>
                            <AccordionContent className="px-2">
                        ...
                        <AccordionItem className="mt-4" value="item-4" >
                            <AccordionTrigger className="px-2 text-xl text-start sm:text-4xl">Where can I learn about membership specials, class schedules, gym amenities, and other local info?</AccordionTrigger>
                            <AccordionContent className="px-2">
