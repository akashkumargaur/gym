                    ...
                    <Accordion className="mt-4" type="single" collapsible>
                        <AccordionItem value="item-1" >
                            ...
                            <AccordionContent className="px-2">
                                ...
                                These Terms of Use apply to your access to and use of the Sites and do not alter in any way the terms and conditions of any other agreement you may have with CoreFit GYM India unless otherwise directed by CoreFit GYM India. If
                        ...
                        <AccordionItem className="mt-4" value="item-7" >
                            ...
                            <AccordionContent className="px-2">
                                ...
                                all statutory and implied guarantees, warranties and conditions of any kind in connection with this Website and its contents are expressly disclaimed. Core Fitness India does not exclude any statutory or implied guarantee, condition or warranty which cannot be lawfully excluded;
                                Core Fitness India does not warrant that your access to this Website will be uninterrupted or that this Website will operate error free, that any defects will be corrected or that this Website and their servers are free of computer viruses, trojans, spyware and other harmful material;
                                Core Fitness India does not warrant that it will be able to prevent any unlawful, harmful or inappropriate use, modification or alteration of this Website, or that it will give notice of such use, modification or alteration;
                                Core Fitness India does not warrant or make any representations about the correctness, accuracy, currency, completeness, reliability, quality or otherwise of this Website or its contents. Core Fitness India may change this Website or limit or terminate your access to this Website at any time without notice.
                                Core Fitness India makes no representation that the content of this Website complies with the laws of any country outside India. If you access this Website from outside India, you do so at your own risk and you are responsible for ensuring compliance with all laws in the place where you are located.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="mt-4" value="item-8" >
                            ...
                            <AccordionContent className="px-2">
                                ...
                                Under no circumstances whatsoever shall Core Fitness India’s aggregate liability resulting from or relating to your use of the Sites exceed Rs 400/-.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="mt-4" value="item-9" >
                            ...
                            <AccordionContent className="px-2 list-disc">
                                ...
                                <ul className="list-disc">
                                    <li>1. Violate any applicable law or regulation;</li>
                                    <li>2. Upload, post, use, transmit, or otherwise make available, including by e-mail, (each, a “Post”) any content or information that is false or inaccurate;</li>
                                    <li>3. Post any content that is unlawful, harmful, threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous, invasive of another’s privacy, or content that could otherwise be considered to be objectionable;</li>
                                    <li>4. Impersonate or use the identity of another person or organization, or falsely state or otherwise misrepresent your affiliation with a person or organization;</li>
                                    <li>5. Engage in any activities or manipulate identifying material to misrepresent the origin of content;</li>
                                    <li>6. Post any content that is subject to any disclosure restrictions;</li>
                                    <li>7. Post any materials, items, information or content that infringes or otherwise violates any patent, copyright, trademark, or any other intellectual property rights;</li>
                                    <li>8. Post any unsolicited or unauthorized advertising or promotional materials, including without limitation, “junk mail,” “spam,” “chain letters,” “pyramid schemes,” or any other form of solicitation;</li>
                                    <li>9. Use the Site to disseminate any information or content, including by e-mail, that is unlawful, harmful, threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous, invasive of another’s privacy, or information or content that could otherwise be considered to be objectionable;</li>
                                    <li>10. Post any material that contains software viruses or any other corrupt computer code, files or programs that impair the use of any computer software or hardware or telecommunications equipment;</li>
                                    <li>11. Interfere with or otherwise limit the use of the Sites by other users; or collect, compile, or store personal information about other users of the Sites;</li>
                                    <li>12. Disrupt or interfere with the operation of the Sites by overloading or exceeding the capacity of the Sites or the systems resources; accounts; usernames and passwords; servers; or networks connected to or accessible through the Sites or any affiliated or linked sites;</li>
                                    <li>13. Disrupt or interfere with the security of, or otherwise cause harm to, the Sites or the systems resources; accounts; usernames and passwords; servers; or networks connected to or accessible through the Sites or any affiliated or linked sites;</li>
                                    <li>14. Use any robot, spider, other automatic device, or manual process to “screen scrape,” monitor, “mine,” or copy the web pages on the Sites or the content contained therein without Core Fitness India’s prior, express, and written permission; or</li>
                                    <li>15. Use the Sites for commercial purposes.</li>
                                </ul>
                                You agree that you are solely responsible for the Post of any content that you make available on or send through the Sites (“User Content”). In addition to the rights granted to Core Fitness elsewhere in these Terms of Use, you hereby grant Core Fitness the irrevocable right to copy and use User Content in connection with the Sites and for the purposes related to your Post of the User Content. Although Core Fitness has no obligation to screen, edit or monitor any of the User Content or user conduct on the Sites, Core Fitness reserves the right, and has absolute discretion, to remove, screen or edit any User Content and to monitor any user conduct on the Sites at any time and for any reason without notice. Your User Content may be available on the Sites for a limited period of time, as determined by Core Fitness in its sole discretion. You are solely responsible for creating backup copies and replacing any of your User Content at your sole cost and expense.

                                By the Post of User Content to the Sites, you represent and warrant that (a) the User Content is non-confidential and is not subject to disclosure restrictions under any applicable data privacy laws or regulations; (b) you have all necessary rights to Post the User Content to the Sites and to grant the rights to Core Fitness you grant in these Terms of Use; (c) the User Content is accurate and not misleading or harmful in any manner; (d) the User Content, and your use and the Post thereof in connection with the Sites, does not and will not violate these Terms of Use or any applicable local, state, national or international statute, regulation, or law.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem className="mt-4" value="item-12" >
                            ...
                            <AccordionContent className="px-2">
                                ...
                                Core Fitness may modify, change, suspend, terminate or discontinue the operation of the Sites or the provision of any services without notice and Core Fitness reserves the right to refuse service to anyone at any time, with or without cause.
                                Our commitment to accessibility
                                At Core Fitness, we’re committed to accessibility, diversity and inclusion. Whether you’re accessing this website using assistive technologies like a screen reader, a magnifier, voice recognition software, or switch technology, our mission is to provide the highest level of service that we can.
                                ...
                                If you experience any issues or would like to contact us with suggestions for improvement, please email us at memberexperience@Corefitness.in.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem className="mt-4" value="item-15" >
                            ...
                            <AccordionContent className="px-2">
                                ...
                                The payment receipt for the completion of a transaction shall be provided by the respective payment
                                processing service provider and the transaction summary shall be provided by Core Fitness
                                India.
                                Core Fitness India shall not be responsible for any unauthorised transactions conducted on
                                our Sites using your payment card or internet banking. Core Fitness India shall not be
                                obligated to refund any money to you in such instances. Unless otherwise specified, any amounts paid to Core Fitness India are nonrefundable.

                                Further, Core Fitness India is not liable for any payments that are declined or remain
                                ...
                                your payment card has expired; or (4) circumstances beyond Core Fitness Indias control
