    ...
    return (
        ...
        overflow-y-auto">
            ...
            <div className="container ml-auto py-6 h-fit  ">
                <div className="sm:grid sm:grid-cols-2 gap-4 justify-center items-center  mt-10 mb-10 sm:mx-8  w-full  ">
                    <div className=" mx-4  font-bold flex flex-col items-center">
                        <h1 className={`p-2 ${myfont.className} text-center sm:text-5xl`}>Mission </h1>
                    ...
                    <div className=" mx-4  font-bold flex flex-col items-center">
                        <h1 className={`p-2 ${myfont.className} text-center sm:text-5xl`}>Goal</h1>
                    ...
                    <div className=" mx-4 font-bold flex flex-col items-center">
                        <h1 className={`p-2 ${myfont.className} text-center sm:text-5xl`}>Who Are We? </h1>
                    ...
                    <div className=" mx-4 font-bold flex flex-col items-center">
                        <h1 className={`p-2 ${myfont.className} text-center sm:text-5xl`}>Community </h1>
